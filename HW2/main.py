...
def parse_args():
    ...
    parser.add_argument('--num_iters', type=int, default=9,help='iter nums of outer loop')
    ...
    parser.add_argument('--dropout',type=float,default=2e-5,help='dropout prob in final layer')
    parser.add_argument('--output_dim',type=int,default=3)
    parser.add_argument('--max_len',type=int,default=85,help='max lenth of word vector')
    parser.add_argument('--gpu_index',type=int,default=0)
    #parser.add_argument('--eval_freq',type=int,default=1)
    parser.add_argument('--lr',type=float,default=2e-5,help='learning rate')
    parser.add_argument('--weight_decay',type=float,default=0.0001,help='l2 regulation rate')
    '''bert config'''
    ...
    parser.add_argument('--attention_probs_dropout_prob',type=float,default=0.1,help='attention dropout prob in pretrained bert model')
